...
public class PizzaMessage {
	...
	private static final List<String> pizzaShop = List.of("A001", "B001", "C001",
		"D001", "E001", "F001", "G001", "H001", "I001", "J001", "K001", "L001", "M001", "N001", "O001", "P001", "Q001");
	...
	// 랜덤한 메시지를 생성하고, 스토어명을 key로 나머지 정보를 value로 하여 Hashmap을 생성하여 반환.
